...
namespace AISNavigation{
  ...
  template <typename T, typename I>
  PoseGraph<T,I>::Edge::Edge(typename PoseGraph<T,I>::Vertex* from, typename PoseGraph<T,I>::Vertex* to, const typename PoseGraph<T,I>::TransformationType& m, const typename PoseGraph<T,I>::InformationType& i) : Graph::Edge(from, to){
    setAttributes(m,i);
  }
  ...
  template <typename T, typename I>
  void PoseGraph<T,I>::Edge::setAttributes(const typename PoseGraph<T,I>::TransformationType& mean_, const typename PoseGraph<T,I>::InformationType& information_){
    _mean=mean_;
  ...
  template <typename T, typename I>
  typename PoseGraph<T,I>::Vertex* PoseGraph<T,I>::addVertex(int id, const typename PoseGraph<T,I>::TransformationType& pose, const typename PoseGraph<T,I>::InformationType& information){
  ...
  template <typename T, typename I>
  typename PoseGraph<T,I>::Edge*   PoseGraph<T,I>::addEdge(Vertex* from, Vertex* to, const typename PoseGraph<T,I>::TransformationType& mean, const typename PoseGraph<T,I>::InformationType& information) {
