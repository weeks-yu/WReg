...
extern bool        isMClicked;                                          //*NEW* Clicking the right mouse button?
...
LRESULT CALLBACK WindowProc (HWND hWnd, UINT uMsg, WPARAM wParam, LPARAM lParam)
{
	...
	GL_Window* window = (GL_Window*)(GetWindowLong (hWnd, -21));
	...
	switch (uMsg)														// Evaluate Window Message
	{
		...
		{	short zDelta   =   (short)   HIWORD(wParam);  
			zoomSize += zDelta / 1200.0f;
			if(zoomSize > 10.0f) zoomSize = 10.0f;
		...
		case WM_CREATE:													// Window Creation
		{
			...
			SetWindowLong (hWnd, -21, (LONG)(window));
		}
		return 0;														// Return
